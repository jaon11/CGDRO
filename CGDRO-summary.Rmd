...
# Example 1 — DRlm: Classification (L=2 groups, C=3 (K=2) classes)
...
fit <- cgdro(Xlist, ylist, X0,
             family = "drlm_cls", f_learner = "linear", w_learner = "linear")
...
# Example 2 — DRlm: Regression (High-dim, L=2 domains)
...
fit <- cgdro(list(X1,X2), list(Y1,Y2), X0 = X0,
             family = "drlm_reg", 
             loading_mat = loading.mat, intercept = FALSE,
...
fit <- cgdro(Xlist, Ylist, X0,
             family = "drol", f_learner = "xgb", w_learner = "linear",
             bias_correct = TRUE,
             priors = NULL,
             ridge = 1e-8,
             seed = 123)
